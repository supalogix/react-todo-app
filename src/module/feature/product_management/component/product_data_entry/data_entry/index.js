...
export const DataEntry = (props) => {
    ...
    return <div className="max-w-lg border border-gray-100 rounded-2xl p-8">
        ...
        <div>
            ...
            <select className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-light-blue-500 focus:border-light-blue-500 sm:text-sm rounded-md" value={props.productStatus} onChange={event => props.onStatusChanged(event.target.value)}>
...
export const sfDataEntry = dispatch => state => {
    ...
    return {
        ...
        onStatusChanged: (option) => () => dispatch(Event.productStatusChanged(option)),
